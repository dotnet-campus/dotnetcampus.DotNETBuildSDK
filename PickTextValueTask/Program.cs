...
namespace PickTextValueTask
{
    public class Program
    {
        ...
        private static void PickTextValue(PickTextValueOption option)
        {
            ...
            if (!match.Success)
            {
                throw new ArgumentException(
                    $"Can not match regex={option.InputRegex} in InputFile={option.InputFilePath} \r\n The file content is\r\n {inputText}");
            }
            ...
            {
                throw new ArgumentException(
                    $"Can not match regex={option.ReplaceRegex} in OutputFile={option.OutputFilePath} \r\n The file content is\r\n {outputText}");
            }
